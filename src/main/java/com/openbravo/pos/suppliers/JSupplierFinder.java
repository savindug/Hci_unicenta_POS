...
//        m_jKeys.setSupplierFinder(this);
    ...
    private void initComponents() {
        ...
        jImageViewerSupplier.setBackground(new java.awt.Color(28, 35, 49));
        jImageViewerSupplier.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jListSuppliers.setBackground(new java.awt.Color(75, 81, 93));
        jListSuppliers.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jListSuppliers.setForeground(new java.awt.Color(255, 255, 255));
