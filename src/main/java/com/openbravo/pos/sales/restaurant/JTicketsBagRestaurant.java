...
public class JTicketsBagRestaurant extends javax.swing.JPanel {
 ...
 private void printTicket(String sresourcename, TicketInfo ticket, String table) {
    ...
    private void initComponents() {
        ...
        m_TablePlan.setForeground(new java.awt.Color(255, 255, 255));
        ...
        m_MoveTable.setForeground(new java.awt.Color(255, 255, 255));
        ...
        m_DelTicket.setForeground(new java.awt.Color(255, 255, 255));
        ...
        j_btnKitchen.setForeground(new java.awt.Color(255, 255, 255));
